...
def build():
    ...
    steps = [
        ("Private upload", "The client obtains a guest- or account-scoped upload path, transfers the audio, and verifies it before analysis."),
    ...
    for filename, caption in [
        ("00-account-choice.png", "Figure 8. Guest and saved-account entry options."),
        ("05-upload-selected.png", "Figure 9. Supplied audio selected and verified."),
