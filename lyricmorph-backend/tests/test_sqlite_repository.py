from app.models import CreatorMode, Genre, JobRecord, JobStatus, SourceType, VoiceTakeRequest, now_utc
from app.repository import SqliteJobRepository, SqliteStore, SqliteUsageRepository, SqliteVoiceTakeRepository
from app.worker import build_song_blueprint, fallback_song_analysis


def test_sqlite_project_vault_persists_jobs_takes_and_usage(tmp_path):
    ...
    jobs.create(job)
    assert usage.increment("generation_2026_07") == 1
    ...
    assert reloaded_usage.get("generation_2026_07") == 1
